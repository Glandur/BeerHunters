...
import ca.etsmtl.beerhunters.adapter.BeerAdapter;
import ca.etsmtl.beerhunters.model.BeerContainerResponse;
import butterknife.Bind;
import butterknife.ButterKnife;
import ca.etsmtl.beerhunters.util.RecyclerViewScrollEvent;
import ca.etsmtl.beerhunters.util.RxRecyclerView;
import ca.etsmtl.beerhunters.util.ScrollFilter;
import ca.etsmtl.beerhunters.util.ScrollToPageLoader;
